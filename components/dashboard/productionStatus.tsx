...
export default function OrderStatusProgress({ statuses = [] }: OrderStatusProgressProps) {
  ...
  return (
    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-5 h-full">
      <h3 className="font-bold text-gray-800 text-base">وضعیت سفارشات</h3>
